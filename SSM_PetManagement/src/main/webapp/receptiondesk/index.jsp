...
<body>
<c:if test="${sessionScope.addResult != null}">
    <script>
        alert("${sessionScope.addResult}");
                ...
                <nav class="header-menu ">
                    <ul>
                        ...
                        <li><a href="#">商店<i class="fas fa-chevron-down"></i></a>
                            <div class="submenu">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/product1">商店</a></li>
                ...
                <div class="header-menu-right">
                    ...
                    <div class="header-menu-btn">
                        <ul>
                            ...
                            <li><a href="${pageContext.request.contextPath}/receptiondesk/login.jsp">登录,注册</a></li>
        ...
        <nav class="header-menu">
            <ul class="nav_scroll">
                <li class="menu-item-has-children"><a href="#">Home</a>
                    <ul class="sub-menu">
                        <li><a href="#">首页 01</a></li>
                        <li><a href="#">首页 02</a></li>
                    </ul>
                </li>
                <li><a href="#">商店 </a>
                    <ul class="sub-menu">
                    ...
                    <div class="col-lg-6">
                        <div class="banner-content">
                            ...
                            <div class="banner-btn cat-shop-btn">
                                <a href="#">准备开始 <i class="bi bi-arrow-right-short"></i> <span></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="category-single-box style1 wow fadeInUp">
                    <div class="category-box-content">
                        ...
                        <div class="category-box-btn cat-shop-btn">
                            <a href="#">显示全部 <i class="bi bi-arrow-right-short"></i> <span></span></a>
                        </div>
                    </div>
...
<div class="sidebar-menu-wrapper">
    <div class="cart_sidebar">
        ...
        <ul class="btns_group ul_li">
            ...
            <li><a href="#" class="btn btn_border border_black text-uppercase">Checkout</a></li>
        </ul>
    </div>
            ...
            <div class="sidebar-textwidget">
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        <div class="nav-logo">
                            <a href="#"><img src="../static/picture/cat-logo.png" alt="logo"></a>
                        </div>
                        <!-- widget search -->
                        ...
                        <div class="product-category">
                            ...
                            <ul class="list-style-one">
                                <li><a href="#"> Cute Cat <span>10</span></a></li>
                                <li><a href="#"> White Cat <span>1</span></a></li>
                                <li><a href="#"> Asian Cat <span>8</span></a></li>
                                <li><a href="#"> British Cat <span>8</span></a></li>
                                <li><a href="#"> Cat Food <span>15</span></a></li>
                                <li><a href="#"> Baby Cat <span>11</span></a></li>
                                <li><a href="#"> Frappuccino Coffe <span>6</span></a></li>
                                <li><a href="#"> Americano Cat <span>10</span></a></li>
                                <li><a href="#"> Cat Soup <span>5</span></a></li>
                                <li><a href="#"> Adult CAt <span>2</span></a></li>
                                <li><a href="#"> All Categories <span>1</span></a></li>
                            </ul>
                        </div>
                        <!-- Recent Gallery -->
                            ...
                            <ul>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb8.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb7.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb3.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb4.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb5.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="widget-gallery-thumb">
                                        <a href="#"><img src="../static/picture/collection-thumb6.jpeg" alt="thumb"></a>
                                    </div>
                                </li>
                            </ul>
                        </div>
